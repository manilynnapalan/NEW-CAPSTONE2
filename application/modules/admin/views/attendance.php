                  ...
                  <tbody class="text-center">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <!-- <button class="btn btn-warning" data-toggle="modal" data-target="#modal-delete<?= $value->event_id;?>"></button> -->
                          <a href="<?= base_url('admin/checkAttendance/'.$value->event_id)?>" class="btn btn-warning"><i class="fas fa-eye"></i> View</a>
                        </td>
                      </tr>
