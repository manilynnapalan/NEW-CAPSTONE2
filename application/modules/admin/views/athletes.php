                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <textarea id="up_athlete_data<?= $value->account_id?>" hidden><?= json_encode(['account_id'=>$value->account_id,'pro_pic'=>$value->pro_pic,'firstname'=>$value->firstname,'lastname'=>$value->lastname,'id_number'=>$value->username,'address'=>$value->address,'course'=>$value->course,'date'=>$value->birthdate,'gender'=>$value->gender,'sport'=>$value->sports,'school_year'=>$value->sy_start.'-'.$value->sy_end])?></textarea>
                    ...
                    <div class="form-group">
                      <label>Date:</label>
                        <div class="input-group date" id="up_reservationdate" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" placeholder="Enter/Select Birthdate" name="up_datebirth" />
