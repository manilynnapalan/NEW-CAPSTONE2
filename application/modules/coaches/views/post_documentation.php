                      ...
                      <div class="modal fade" id="modal-delete<?php echo $value->post_id;?>">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <form action="<?php echo base_url('coaches/delete_post/'.$value->post_id)?>" method="post">
      ...
      <div class="modal fade" id="modal-register">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="<?php echo base_url('coaches/insert_documentation/')?>" method="post" enctype="multipart/form-data" autocomplete="off">
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
