  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color:  #f4f6f9">
    ...
    <ul class="navbar-nav">
      ...
      <ol class="breadcrumb float-sm-right" style="background-color: #fff;padding: 0.5rem 1rem;border-radius: 30px;">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url('medical_staff/')?>">Dashboard</a></li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="media" style="padding: 10px 30px">
            <div class="media-body">
              <a href="<?= base_url('medical_staff/profile/')?>" class="btn btn-primary mb-3" style="width: 100%;">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<?= base_url('medical_staff/')?>" class="nav-link <?= $this->uri->segment(2) == '' ? 'active':''?>">
