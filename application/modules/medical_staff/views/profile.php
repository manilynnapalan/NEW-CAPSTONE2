                  ...
                  <div class="col-sm-12">
                    ...
                    <ul class="list-group list-group-unbordered mb-3 text-center">
                      ...
                      <li id="li_update_profile" class="list-group-item text-left" style="display:none">
                        <form action="<?= base_url('medical_staff/update_profile/')?>" method="post" enctype="multipart/form-data">
                          <center>
                          ...
                          <div class="input-group">
                            <input type="text" class="form-control" placeholder="Enter M.I." name="mi" value="<?= $hresult->middle_initial?>" maxlength="1" required>
                            <div class="input-group-append">
                              <div class="input-group-text">
                                <span class="fas fa-user"></span>
                              </div>
                          ...
                          <label class="mt-1">License Number</label>
                          <div class="input-group">
                            <input type="text" class="form-control" placeholder="Enter License Number" name="license_number" value="<?= $hresult->address?>" required>
                            <div class="input-group-append">
                              <div class="input-group-text">
                                <span class="fas fa-user"></span>
                              </div>
                          ...
                          <label class="mt-1">Date Validity</label>
                          <div class="input-group">
                            <input type="date" class="form-control" placeholder="Enter Date Validity" name="validity" value="<?= $hresult->birthdate?>" required>
                            <div class="input-group-append">
                              <div class="input-group-text">
